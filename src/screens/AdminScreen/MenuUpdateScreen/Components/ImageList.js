...
const ImageList = React.forwardRef(({ food, addFoodImage, removeFoodImage }, inputRef) => {
  ...
  return (
    <div className="update_contents-row">
      ...
      <div className="product-imgs">
        {visible.visible && <Modal food={food} setVisible={setVisible} visible={visible} removeFoodImage={removeFoodImage} />}
...
export default connect(mapStateToProps, mapDispatchToProps, null, { forwardRef: true })(ImageList);
