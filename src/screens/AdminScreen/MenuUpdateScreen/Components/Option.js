...
const Option = ({food,updateFood}) => {
    ...
    const addOption = async () => {
        ...
        updateFood(food.id,{...food,options:[
            ...food.options,
            {
                option:Option,
                price:AdditionalPrice
    ...
    return (<div className="update_contents-row">
                ...
                return (
                    <div key={`${e.id}/${index}`} className="menu-option">
                        ...
                        <div>
                            ...
                            <img src={closeImage} alt="closebtn" onClick={()=>removeOption(index)}/>
                        </div>
                    </div>
                );
            })}
        <button onClick={() => setIsAddOption(!IsAddOption)} className="edit-button">추가</button>
        {IsAddOption && (
            <AddOptionScreen
